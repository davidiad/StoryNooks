...
public class SubtitleParser
{
    ...
    public List<SubtitleUnit> ParseStream(Stream srtStream, Encoding encoding)
    {
        ...
        var items = new List<SubtitleUnit>();
            ...
            foreach (var srtSubPart in srtSubParts)
            {
                ...
                foreach (var l in lines)
                {
                    ...
                    if (item.StartTime == 0 && item.EndTime == 0)
                    {
                        ...
                        if (success)
                        {
                            item.StartTime = ((float)startTc) / 1000f;
                            item.EndTime = ((float)endTc) / 1000f;
                        }
                    }
                    else
                    {
